...
export interface BlockEngineValidatorClient extends grpc.Client {
  ...
  SubscribeBundles(argument: _block_engine_SubscribeBundlesRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_dto_Bundle__Output>;
  SubscribeBundles(argument: _block_engine_SubscribeBundlesRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_dto_Bundle__Output>;
  subscribeBundles(argument: _block_engine_SubscribeBundlesRequest, metadata: grpc.Metadata, options?: grpc.CallOptions): grpc.ClientReadableStream<_dto_Bundle__Output>;
  subscribeBundles(argument: _block_engine_SubscribeBundlesRequest, options?: grpc.CallOptions): grpc.ClientReadableStream<_dto_Bundle__Output>;
...
export interface BlockEngineValidatorHandlers extends grpc.UntypedServiceImplementation {
  ...
  SubscribeBundles: grpc.handleServerStreamingCall<_block_engine_SubscribeBundlesRequest__Output, _dto_Bundle>;
...
export interface BlockEngineValidatorDefinition extends grpc.ServiceDefinition {
  ...
  SubscribeBundles: MethodDefinition<_block_engine_SubscribeBundlesRequest, _dto_Bundle, _block_engine_SubscribeBundlesRequest__Output, _dto_Bundle__Output>
}
