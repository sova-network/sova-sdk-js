...
goog.exportSymbol('proto.block_engine.StreamMempoolResponse', null, global);
 ...
 * @constructor
 */
proto.block_engine.StreamMempoolResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.block_engine.StreamMempoolResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.block_engine.StreamMempoolResponse.displayName = 'proto.block_engine.StreamMempoolResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.block_engine.StreamMempoolResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.block_engine.StreamMempoolResponse.toObject(opt_includeInstance, this);
};
 ...
 *     http://goto/soy-param-migration
 * @param {!proto.block_engine.StreamMempoolResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.block_engine.StreamMempoolResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.block_engine.StreamMempoolResponse}
 */
proto.block_engine.StreamMempoolResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.block_engine.StreamMempoolResponse;
  return proto.block_engine.StreamMempoolResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @param {!proto.block_engine.StreamMempoolResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.block_engine.StreamMempoolResponse}
 */
proto.block_engine.StreamMempoolResponse.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @return {!Uint8Array}
 */
proto.block_engine.StreamMempoolResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.block_engine.StreamMempoolResponse.serializeBinaryToWriter(this, writer);
 ...
 * @param {!proto.block_engine.StreamMempoolResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.block_engine.StreamMempoolResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
